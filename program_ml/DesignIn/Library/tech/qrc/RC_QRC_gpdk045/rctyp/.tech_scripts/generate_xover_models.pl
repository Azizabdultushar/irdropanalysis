...
printf outf "`perl \$script_dir/mw_3d.pl 6 \$profile_dir \$model_dir \$techfile \$version -exe $exe_dir`;\n\n";
...
if ($opt_sensitivity) {
  ...
  printf outf "`perl \$script_dir/mw_3d.pl -sensitivity $sens_file 6 \$profile_dir \$model_dir \$techfile \$version -exe $exe_dir`;\n\n";
}
